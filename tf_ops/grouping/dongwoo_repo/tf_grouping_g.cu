...
__global__ void query_ball_point_gpu(int b, int n, int m, const float *radius_, int nsample, const float *xyz1, const float *xyz2, int *idx, int *pts_cnt) {
    //float radius = radius_;//[0];
...
void queryBallPointLauncher(int b, int n, int m, const float *radius_, int nsample, const float *xyz1, const float *xyz2, int *idx, int *pts_cnt) {
    query_ball_point_gpu<<<b,256>>>(b,n,m,radius_,nsample,xyz1,xyz2,idx,pts_cnt);
